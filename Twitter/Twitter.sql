...
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'Ali123', 18, N'Pakistan')
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'Aliza', 40, N'USA')
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'Aysha', 19, N'Iran')
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'DonaldTrump', 60, N'USA')
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'ImranKhan', 55, N'Pakistan')
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'Natasha', 28, N'USA')
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'Samuel', 37, N'Australia')
INSERT [dbo].[users] ([UserName], [Age], [Country]) VALUES (N'Sara', 30, N'Iran')
